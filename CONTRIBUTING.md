...
```bash
git clone git@github.com:<username>/craft-application --recurse-submodules
cd craft-application
git remote add upstream git@github.com:canonical/craft-application
git fetch upstream
```
...
cd craft-application
git remote add upstream https://github.com/canonical/craft-application
git fetch upstream
```
...
[Diátaxis](https://diataxis.fr) category for the page. A Craft Application maintainer
...
On GitHub, [open a PR](https://github.com/canonical/craft-application/compare) for your
branch in Craft Application.
