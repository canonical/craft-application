...
class CraftBaseModel(pydantic.BaseModel):
    ...
    def from_yaml_data(cls, data: dict[str, Any], filepath: pathlib.Path) -> Self:
        ...
        try:
            ...
            cls.transform_pydantic_errors(pydantic_errors)
            raise errors.CraftValidationError.from_pydantic_errors(
                pydantic_errors, file_name=filepath.name
            ) from None
    ...
    def transform_pydantic_errors(cls, errors: Iterable[ErrorDict]) -> None:
        ...
        :param errors: The list of validation errors, as provided by
