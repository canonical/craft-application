...
Craft Application is the basis library for all Starcraft applications.

The aim is to provide a single source of truth for implementation of common
Starcraft mechanisms, such as application services and project models.

This library is most useful for implementers of tools in the Starcraft family.
