...
``craft_application.models.Platform`` class and modifying it as
needed.:ref:`how-to-customize-platforms` contains implementation instructions. The class
has several validators that may need to be modified.
