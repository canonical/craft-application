...
@pytest.mark.usefixtures("non_empty_project_dir")
def test_init_fails_without_force_on_non_empty_dir(
    init_command: InitCommand,
    template_dir_with_testcraft_yaml_j2: Path,
    mocker,
):
...
def test_init_does_not_fail_with_force_on_non_empty_dir(
    init_command: InitCommand,
    ...
    parsed_args = get_command_arguments(force=True)
