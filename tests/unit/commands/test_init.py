...
def test_profiles(init_command, fake_template_dirs):
    """Test profile generation."""
    assert init_command.default_profile == "simple"
    assert init_command.template_dirs == [
        fake_template_dirs / "simple",
        fake_template_dirs / "other-template",
    ]
    assert init_command.profiles == ["simple", "other-template"]
